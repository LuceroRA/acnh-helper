...
class PricesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->allowEmptyString('monday_price');

        $validator
            ->allowEmptyString('tuesday_price');

        $validator
            ->allowEmptyString('wednesday_price');

        $validator
            ->allowEmptyString('thursday_price');

        $validator
            ->allowEmptyString('friday_price');

        $validator
            ->allowEmptyString('saturday_price');

        $validator
            ->allowEmptyString('sunday_price');
